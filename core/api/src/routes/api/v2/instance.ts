...
const instanceV2 = new Hono();

// https://docs.joinmastodon.org/methods/instance/
instanceV2.get('/instance', (c) => {
  c.header('Cache-Control', 'max-age=604800, stale-while-revalidate=86400');
  const resp = {
    domain: 'log.lu',
    title: '不走老路',
    version: getVersion(),
    source_url: 'https://github.com/willin/log-lu',
    description: '',
    usage: {
      users: {
        active_month: 1
    ...
    thumbnail: {
      url: 'https://log.lu/packs/media/images/preview-6399aebd96ccf025654e2977454f168f.png'
    },
    languages: ['en'],
    configuration: {
      urls: {
        streaming: 'wss://log.lu',
        status: null
      },
      accounts: {
